...
from .views import productView, PrdDetailView, DetailPaging, ExcelDownload, EditReviewGoodToBadView, DetailPagingDate
...
urlpatterns = [
    ...
    path('product_detail/datePaging/', DetailPagingDate.as_view(), name=('detail_paging')),
]
